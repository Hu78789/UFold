...
def postprocess(u, x, lr_min, lr_max, num_itr, rho=0.0, with_l1=False, s=math.log(9.0), include_nc=False):
    """
    ...
    :param with_l1:
    :param s: threshold parameter
    :param include_nc: whether to include non-canonical base pairs
    :return:
    """
    if include_nc:
